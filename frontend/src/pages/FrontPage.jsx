  ...
  return (
    <>
      <section className="h-[70vh] w-full bg-black text-white relative top-[5rem] flex justify-between pl-10  overflow-hidden mb-10 ">
        <div className="flex flex-col gap-6 ssiz-450:gap-5  w-[60%]  ssiz-450:w-[100%]   mt-10  ">
          <div className=" ">
            <span className="text-2xl   ssiz-450:text-xl  font-bold   ">
              <h2>Hi, I'm Jiban Pandey</h2>
            </span>
            <div className="  text-6xl ssiz-450:text-3xl ssiz-450to800:text-5xl text-green-500 font-bold   ">
              <span>
                <h2>App Developer</h2>
          ...
          <div className=" ssiz-950:w-[85%]  w-[80%]  ssiz-850:w-[100%]  ssiz-450:w-[100%] items-center  z-20">
            <span className="w-[60%] ssiz-450:w-[100%] z-20">
              <p className="text-sm ssiz-450:text-xs ">
                ...
                React, Next.js, and React Native || Nodejs , Expressjs ||
                MongoDB . Additionally, I am expanding my skill set into data
                analysis and machine learning using Python frameworks.
              </p>
            </span>
          </div>
          <div className="  w-full h-1/2 flex flex-col justify-between py-6 px-2 ">
            <span>
              ...
              <p className=" text-sm ssiz-450:text-xs text-zinc-300  ">
        ...
        <div className="ssiz-850to950:w-[20%] w-[40%] ssiz-850:hidden flex items-center justify-end  fixed -right-12 top-52 ">
          <div className="icon-wrapper">
            ...
            <div className=" ssiz-850to950:h-[250px] h-[300px] w-[300px] ssiz-850to950:w-[250px] bg-green-600 rounded-full FrontpageCircleShadow overflow-hidden flex items-center justify-end absolute top-0 right-0">
